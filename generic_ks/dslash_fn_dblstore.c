			     ...
			     fn_links_t *fn)
{
    ...
    memset(tempvec, 0, sizeof(su3_vector)*4*sites_on_node);
	...
	terminate(1);
      ...
      memset(templongvec, 0, sizeof(su3_vector)*4*sites_on_node);
...
#ifdef D_FN_GATHER13
#ifdef NO_LONG_LINKS
  Cannot use D_FN_GATHER13 with this action.
#endif
